        ...
        <section className="platform-section settings-panel">
          ...
          {section === "appearance" && <>
            ...
            <div className="settings-form-grid">
              ...
              <label>Interface scale<input type="range" min="0.85" max="1.3" step="0.05" value={draft.appearance.text_scale} onChange={(event) => setDraft({ ...draft, appearance: { ...draft.appearance, text_scale: Number(event.target.value) } })} /><span>Auto × {Math.round(draft.appearance.text_scale * 100)}%</span><small>Adjusts the entire workspace on top of automatic window scaling.</small></label>
